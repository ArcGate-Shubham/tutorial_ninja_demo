...
class TestChangePassword(logclass):
    ...
    def test_change_password_without_password_or_without_confirm_password_input(self):
        log = self.getthelogs()
        login = Login(self.driver)
        log.info('TEST CASE, test_change_password_without_password_or_without_confirm_password_input')
        log.info("Test Case Starting")
        login.click_on_my_account_link_text()
        login.click_on_login_link_text()
        login.input_email(config.get("crediential","login_email"))
        ...
        if change.display_error_message():
            ...
            self.driver.save_screenshot('Screenshots/test_change_password_without_password_or_without_confirm_password_input.png')
            log.critical('Test Case Fail')
            assert False
            
    def test_change_password_without_password_or_without_confirm_password_input_click_back_button(self):
        log = self.getthelogs()
        login = Login(self.driver)
        log.info('TEST CASE, test_change_password_without_password_or_without_confirm_password_input_click_back_button')
        log.info("Test Case Starting")
        login.click_on_my_account_link_text()
        login.click_on_login_link_text()
        login.input_email(config.get("crediential","login_email"))
        ...
        change = ChangePassword(self.driver)
        change.click_back_button()
        if 'Account' in change.display_account_word().text:
            assert True
            log.info('Test Case Pass')
        else:
            self.driver.save_screenshot('Screenshots/test_change_password_without_password_or_without_confirm_password_input_click_back_button.png')
            log.critical('Test Case Fail')
            assert False
            
    def test_change_password_with_password_or_with_confirm_password_input_click_back_button(self):
        log = self.getthelogs()
        login = Login(self.driver)
        log.info('TEST CASE, test_change_password_with_password_or_with_confirm_password_input_click_back_button')
        log.info("Test Case Starting")
        login.click_on_my_account_link_text()
        login.click_on_login_link_text()
        login.input_email(config.get("crediential","login_email"))
        ...
        if 'Account' in change.display_account_word().text:
            ...
            self.driver.save_screenshot('Screenshots/test_change_password_with_password_or_with_confirm_password_input_click_back_button.png')
            log.critical('Test Case Fail')
            assert False
